                    ...
                    if (repetitionOfSpecialRecord.length === 1) {
                      ...
                      if (i === 0) {
                        ...
                        afternoonBonus +=
                          repetitionOfSpecialRecord[i].afternoonShiftHours * overlapOfBaseValueForAfternoonSpecial[0];
                        nightBonus +=
                          repetitionOfSpecialRecord[i].nightShiftHours * overlapOfBaseValueForNightSpecial[0];
                      } else if (i === 1) {
                        if (
            ...
            <div>
              {record.map((v, i) => {
                function handleClick() {
                  setRecordDetail(true);
                }
                return (
                  <div
                    key={i}
                    className="mb-3 py-2 border border-gray-600 rounded-md flex justify-evenly items-center"
                    onClick={handleClick}
                  >
                    <div>{v.individual_name}</div>
                    <div>{v.name}</div>
                    <div>
                      <div>{moment(v.in_time).format('YYYY/MM/DD')}</div>
                      <div>{moment(v.in_time).format('HH:mm')}</div>
                    </div>
                    <div>
                      <div>{moment(v.out_time).format('YYYY/MM/DD')}</div>
